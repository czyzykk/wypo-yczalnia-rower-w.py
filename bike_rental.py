...
def main():
    ...
    if choice == 2:
        while True:
            timetocalculate = input("Wprowadź godzinę i minute (format HH:MM): ")
            ...
            try:
                ...
                if 0 <= hours < 24 and 0 <= minutes < 60:
                    ...
                    print("Godzina lub minuty są niepoprawne. Spróbuj ponownie.")
    
            except ValueError:
                print("Wybrany format jest niepoprawny. Użyj formatu HH:MM. Spróbuj ponownie.")
